...
# This list of LS_COLORS comes from: https://github.com/trapd00r/LS_COLORS/blob/master/LS_COLORS
...
fpath=($DOTZSH/zsh/functions $fpath)

autoload -U $DOTZSH/zsh/functions/*(:t)
...
bindkey '^R' history-incremental-search-backward
# These below are so iTerm doesn't get angry with shift + arrow
# or shift + alt + arrow
